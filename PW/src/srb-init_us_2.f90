...
!
!----------------------------------------------------------------------
subroutine init_us_2_srb (npw_, igk_, q_, typ_, vkb_)
  !----------------------------------------------------------------------
  !
  ...
  !
  USE kinds,      ONLY : DP
  USE ions_base,  ONLY : nat, ntyp => nsp, natom => na, ityp, tau
